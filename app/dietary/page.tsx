  ...
  return (
    <div className="flex flex-col w-full m-0 items-center">
      <div className="w-screen ">
        ...
        >
          <div className=" flex flex-col justify-center items-center md:items-start md:flex-row w-full p-[150px]">
            <div className="w-1/2 flex flex-col justify-center md:items-center items-center">
              {/* <h1 className="text-2xl font-bold">
                tasty diabetes-friendly meals you can enjoy.
              </h1> */}
              <p className="text-3xl md:text-center text-center font-bold py-6">
      ...
      <div
        ...
        id="ourCategories"
      >
        <p className="text-[57px] font-[700] font-Roboto-Black text-center text-[#211F26]">
