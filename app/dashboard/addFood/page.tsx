                    ...
                    <div className='orderContent bg-white flex flex-col my-10'>
                        <div className="max-w-lg mx-auto p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    <label htmlFor="image" className="block mb-1 font-semibold">Food Image:</label>
                                ...
                                <div>
                                    <label className="block mb-1 font-semibold">Is Instant:</label>
                                    <input
                                        type="checkbox"
                                        id="isInstant"
                                        name="isInstant"
                                ...
                                <div>
                                    <label htmlFor="categories" className="block mb-1 font-semibold">Categories:</label>
                                    <input
                                        type="text"
                                        id="categories"
                                        name="categories"
                                    ...
                                    />
                                    <p className="text-gray-500 text-sm">Separate multiple categories with commas</p>
                                </div>
                                <div>
