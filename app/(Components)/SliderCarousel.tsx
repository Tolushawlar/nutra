    ...
    return (
        <div className=" mx-auto flex flex-col md:flex-row items-center w-[100vw] mt-0 md:mt-[80px]">
            ...
            <div className='w-[100vw] md:w-[60vw] h-[500px] md:h-[700px]'>
                <Slider{...settings2}>
                    <div className="px-[20px] md:px-[90px] pt-[100px] md:pt-[150px] text-center md:text-left gap-[2px] md:gap-10 flex flex-col items-center justify-center md:justify-start  bg-[#003D28] w-[100vw] md:w-[80vw] h-[550px] md:h-[700px]">
                        ...
                        <Link to="foodMenus" smooth={true} duration={800} className="ml-[5vw] md:ml-0 cursor-pointer flex flex-row items-center justify-center gap-3  bg-[#BCF800] rounded-[8px] md:rounded-[16px] w-[300px] md:w-[350px] h-[64px] md:h-[90px] mt-[30px] md:mt-[80px]">
                    ...
                    <div className="px-[20px] md:px-[90px] pt-[100px] md:pt-[150px] gap-2 md:gap-10 flex flex-col items-center justify-center md:justify-start bg-[#003D28] w-[100vw] md:w-[80vw] h-[500px] md:h-[700px]">
                        ...
                        <div className="ml-[5vw] md:ml-0 cursor-pointer flex flex-row items-center justify-center gap-3 my-10  bg-[#BCF800] rounded-[8px] md:rounded-[16px] w-[300px] md:w-[350px] h-[64px] md:h-[90px] mt-[30px] md:mt-[80px]">
