            ...
            <div className='w-[100vw] md:w-[60vw] h-[500px] md:h-[700px]'>
                <Slider{...settings2}>
                    ...
                    <div className="px-[20px] md:px-[70px] pt-[100px] md:pt-[100px] gap-5 md:gap-10 flex flex-col items-center justify-center md:justify-start bg-[#003D28] w-[100vw] md:w-[80vw] h-[500px] md:h-[700px]">
                        ...
                        <div className='flex flex-row items-center justify-center md:justify start'>
                            <Link to="bcp" smooth={true} duration={800} className="md:right-0 md:ml-0 cursor-pointer flex flex-row items-center justify-center gap-3 my-10  bg-[#BCF800] rounded-[8px] md:rounded-[16px] w-[300px] md:w-[350px] h-[64px] md:h-[90px] mt-[50px] md:mt-[80px]">
