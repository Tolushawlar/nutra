              ...
              <div className="w-fit space-x-4 flex px-10">
                {categories.map((cat, i) => (
                  <p
                    ...
                    className="font-BwGradual-Regular text-[14px] md:text-[16px] font-[500] bg-[#F1F7F0] cursor-pointer p-[6px] text-nowrap rounded-lg px-[32px] py-[12px] border-[0.8px] border-[#A9C1A9] text-[#003D28]"
                    key={i + "categories_index"}
                  >
                    {cat}
                  </p>
