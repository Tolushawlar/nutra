      ...
      <div className="w-[100vw] md:w-full bg-[#f4f3e7] py-[20px] md:py-[100px] px-[20px] md:px-[50px] shadow-none md:shadow-md  overflow-x-auto md:overflow-x-hidden ">
        <div className="innerDiv md:shadow-md bg-transparent md:bg-white px-0 md:px-[20px] py-[70px] flex flex-col items-center rounded-[24px]">
          ...
          <div className="flex flex-row justify-center md:justify-between items-center mt-7 w-[2000px] md:w-auto gap-4 md:gap-8  ml-[60vw] md:ml-0 px-[70px] md:px-0">
            <div className=" relative left-[60px] md:left-0 mr-[70px] md:mr-0 ml-[600px]  md:ml-0 bg-white md:bg-transparent shadow-md md:shadow-none rounded-[16px] text-left md:text-center md:rounded-0 w-[650px] h-[200px] md:h-fit md:w-1/4 flex flex-row items-start md:items-start mt-5 md:mt-0 p-8">
            ...
            <div className=" bg-white md:bg-transparent shadow-md md:shadow-none rounded-[16px] text-left md:text-center md:rounded-0 w-[650px] h-[200px] md:h-fit md:w-1/4 flex flex-row items-start md:items-start mt-5 md:mt-0 mr-2 p-8">
              ...
              <div className="flex flex-col justify-start md:items-start ml-3 gap-3">
                <h4 className="font-BwGradual-Regular font-[700] text-[#211F26] text-left  text-[20px] md:text-[24px] mr-5 md:mr-[10px]">Custom Order</h4>
                <p className="text-[#322F35] text-left font-Gradual-Regular font-[400] first:text-[14px] md:text-[16px] md:w-[200px] ">Our Custom Order option empowers you to create your own personalized meals.</p>
