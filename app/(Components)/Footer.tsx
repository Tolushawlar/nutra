...
export const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-bg-pri text-text-color">
        <aside>
          <svg
            width="50"
            height="50"
        ...
        <nav>
          ...
          <a className="link link-hover">Instant/Schedule Orders</a>
          <a className="link link-hover">Dietary Meals</a>
          <a className="link link-hover">Bespoke</a>
